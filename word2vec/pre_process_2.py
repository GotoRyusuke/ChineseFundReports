...
This file is for the step 1 and 2
'''
import os
import jieba
import pandas as pd
...
if __name__ == "__main__":
    ...
    # file_path = 'C:/Users/niccolo/Desktop/QLFtask/eastmoney/FullTexts'
    # stopwords_path = 'C:/Users/niccolo/Desktop/QLFtask/eastmoney/word2vec/my_stop_words.xlsx'
    stopwords_path = '/home/users/michaelfan/data/ConfCall/eastmoney/'
    file_path = '/home/users/michaelfan/data/ConfCall/eastmoney/FullTexts'
    code_path_list = [file_path + '/' + code_path for code_path in os.listdir(file_path)]
    results = []
    for code_path in code_path_list:
        process_one_code = process_code(code_path, 2, stopwords_path)
    ...
    test = re.sub(spaces, '', single_file)
